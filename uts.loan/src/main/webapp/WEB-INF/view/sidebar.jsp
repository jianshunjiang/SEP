...
<div class="col-md-2">
    <ul class="nav nav-list">
        ...
        <c:if test="${not empty sessionScope.manager}">
            ...
            <li><a href="/loanManager/account"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
        </c:if>
        ...
        <c:if test="${not empty sessionScope.admin}">
            ...
            <li><a href="/admin/applications"><span class="glyphicon glyphicon-file"></span> Applications</a></li>
